...
#define SUPP_FILE_FORMAT_SWITCH "SUP_FILE_FORMAT"
...
#define DFEAULT_BACK_COLOR "DEFAULT"
#define DFEAULT_BACK_OPACITY "0"
#define DEFAULT_MAIN_LANG "LOCAL"
#define DEFAULT_MAIN_THEME "DEFAULT"
#define DEFAULT_SUPP_FORMAT ".jpg,.jpeg,.png,.gif,.bmp"
