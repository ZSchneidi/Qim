...
**
** Created: Wed 2. Jun 19:49:10 2010
...
static const char qt_meta_stringdata_MainViewer[] = {
    "MainViewer\0"
};

const QMetaObject MainViewer::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_MainViewer,
      qt_meta_data_MainViewer, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MainViewer::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MainViewer))
